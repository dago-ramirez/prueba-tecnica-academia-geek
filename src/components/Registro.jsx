...
export default function Registro() {
    const { cookies, btnSubmit, setBtnSubmit, datos, setDatos } = useContext(DataContext);
    ...
    return (
        <div className='flex flex-col items-center justify-center mx-4' >
            ...
            <form onSubmit={sendData} className='w-full sm:w-4/6 md:w-3/6 mb-24 flex flex-col shadow-xl border-2 border-gray-700 rounded-lg' >
                ...
                <div className="mb-4 mx-6 lg:mx-24 w-56">
                    ...
                    <input id="cedula" name="cedula" type="number" onChange={handleInputChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 text-lg sm:text-xl leading-tight focus:outline-none focus:shadow-outline" placeholder="Cédula" required />
                </div>
                <div className="mb-4 mx-6 lg:mx-24 w-56">
                ...
                <div className="flex items-center justify-evenly mx-2 sm:mx-24 mb-10">
                    <input id="enviar" className="bg-blue-500 hover:bg-blue-700 text-white text-lg font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline cursor-pointer" type="submit" value="Enviar" />
                    <input id="cancelar" className="bg-red-500 hover:bg-red-700 text-white text-lg font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline cursor-pointer" type="reset" value="Cancelar" />
                </div>            
            </form>
        </div>
    )
